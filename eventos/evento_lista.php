<p>  <h3> Listaxe de eventos </h3>

<table border=1 cellpadding=3 width=100%>
<tr> <th> &nbsp;</th> <th>Data</th> <th>Evento</th> </tr>

<form name="f1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>?corpo=operaevento">
...
echo " <tr>
<td><input type=radio name=rdid value=$id title=\"$data-$nome\" ></td>
<td> $data </td> <td> $nome </td>
</tr>";
...
<input type="button" value="Borrar" name="borrar" onclick="confirma_borra_evento()">
