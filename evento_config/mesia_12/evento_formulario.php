...
<p>Introduza os seus datos nos seguintes campos. Os datos marcados con &quot;*&quot; son obrigatorios.</p>
<form name="f1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>?corpo=gardarex" onsubmit="return valida_form_adultos(this)">
...
<tr> <td align="left"> DNI/NIE * :</td> <td align="left">
	<input type="text" namE="dni" title="DNI-NIE" size="15" required maxlength="10">
</td> </tr>
...
<tr> <td align="left"> Provincia * :</td> <td align="left">
	<input type="text" name="provincia" title="provincia" size="30" required pattern="<? echo mb_convert_encoding("[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+{2,35}", "UTF-8");?>">
</td> </tr>
<tr> <td align="left"> Localidade * :</td> <td align="left">
	<input type="text" name="localidade" title="localidade" size="30" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+{2,50}">
</td> </tr>
