<p>  <h3> Listaxe de Resultados </h3>



<table border=1 cellpadding=3 width=100%>
<tr> <th> &nbsp;</th> <th>Data</th> <th>Nome da carreira</th> </tr>

<form name="f1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>?corpo=operares">
...
echo " <tr>
<td><input type=radio name=rdid value=$id title=\"$data-$carreira\" ></td>
<td> $data </td> <td> $carreira </td>
</tr>";
