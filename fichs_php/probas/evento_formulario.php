...
<form name="f1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>?corpo=gardarex" >
...
<tr> <td align="left"> E-mail:</td> <td align="left">
	<input type="email" name="correo" title="e-mail" size="35" required>
</td> </tr>
...
<tr> <td align="left"> M&oacute;bil:</td> <td align="left">
	<input type="tel" name="mobil" title="mobil" size="15" pattern="[0-9]{9}" required>
</td> </tr>
