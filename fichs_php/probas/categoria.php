...
if ( is_numeric ($valor) || strlen($valor)<3 || strlen($valor)>90) $vale.= "<li> Escriba os seus apelidos correctamente.</li>";
	...
	if(comprobar_email($valor)==0)
		...
		break;
		case "club": if (strlen($valor) >100) $vale .= "<li> O nome do club é demasiado longo.</li>";
		else $club=$valor;
		break;
...
if ($ano3 < 23){
	if ($ano3 <= 3) $categoria = "Chupete";
	if ($ano3 == 5 || $ano3==4) $categoria = "Pitufos";
	if ($ano3==7 || $ano3==6) $categoria = "Prebenjamin";
	if ($ano3==9 || $ano3==8) $categoria = "Benjamin";
	if ($ano3==11 || $ano3==10) $categoria = "Alevin";
	if ($ano3==13 || $ano3==12) $categoria = "Infantil";
	if ($ano3==15 || $ano3==14) $categoria = "Cadete";
	if ($ano3==17 || $ano3==16) $categoria = "Juvenil";
	if ($ano3==19 || $ano3==18) $categoria = "Junior";
	if ($ano3==22 || $ano3==21 || $ano3==20) $categoria = "Promesa";

}else{ // else do if de ano < 23

// calculo de categorias.
	if ($idade < 35) $categoria = "Senior";
	if ($idade>=35 && $idade < 41) $categoria = "Veteran A";
	if ($idade>= 41 && $idade < 50) $categoria = "Veteran B";
	if ($idade>= 50 && $idade < 60) $categoria = "Veteran C";
	if ($idade>= 60) $categoria = "Superveteran";
} // fin do if ano < 23.
