...
";
    ...
    if (!isset($_SESSION['valida'], $_SESSION['form_string']) || $_SESSION['form_string'] != $novo_string || $_SESSION['valida']!= "Validado") 
		$vale = " <h3> Erro: </h3>
<p> A operacion que solicitou non pode ser realizada por non estar autorizado para ela. Comprobe que realizou todolos pasos correctamente.</p>
"; 
if ($vale != ""){
ECHO $VALE ;
...
if (!mysql_query("insert into inscritos (nome, apelidos, dni, sexo, correo, mobil, nacemento, provincia, localidade, categoria, licencia, club, evento, enderezo, postal, id_inscri, rexistro) values ('$nome', '$apelidos', '$dni', '$sexo', '$correo', '$mobil', '$data', '$provincia', '$localidade', '$categoria', '$licencia', '$club', '$id', '$enderezo', '$postal', '$codigo', '$rexistro')",$enlace)) {
echo "
<h3> erro: </h3> 
<p align=left>
...
if (!mysql_query("insert into inscritos (nome, apelidos, dni, sexo, correo, mobil, nacemento, provincia, localidade, categoria, licencia, club, evento, enderezo, postal, id_inscri, rexistro) values ('$nome', '$apelidos', '$dni', '$sexo', '$correo', '$mobil', '$data', '$provincia', '$localidade', '$categoria', '$licencia', '$club', '$id', '$enderezo', '$postal', '$codigo', '$recistro')",$enlace)) {
echo "
<h3> erro: </h3> 
<p align=left>
Houbo un erro interno no proceso de inscrici&oacute;n. Por favor, int&eacute;nteo de novo m&acute;is tarde. Gracias.
